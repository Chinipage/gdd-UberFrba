	...
	IF EXISTS (
		...
		FROM GESTION_DE_GATOS.TURNO T
			JOIN inserted I ON I.TURN_ID <> T.TURN_ID
				AND I.TURN_HABILITADO = 1
				AND T.TURN_HABILITADO = 1
		WHERE
			(I.TURN_INICIO BETWEEN T.TURN_INICIO AND T.TURN_FIN - 1 OR I.TURN_FIN BETWEEN T.TURN_INICIO + 1 AND T.TURN_FIN)
			OR (T.TURN_INICIO BETWEEN I.TURN_INICIO AND I.TURN_FIN - 1 OR T.TURN_FIN BETWEEN I.TURN_INICIO + 1 AND I.TURN_FIN)
	)
	BEGIN
